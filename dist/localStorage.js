...
exports.getStorage = exports.setStorage = exports.getUserId = exports._setUserId = void 0;
var userId = '';
function _setUserId(id) {
    userId = id;
}
exports._setUserId = _setUserId;
function getUserId() {
...
function setStorage(key, item) {
    console.log("set storeage".concat(userId).concat(key));
    // localStorage.setItem(userId + key, item);
    localStorage[userId + key] = item;
}
exports.setStorage = setStorage;
function getStorage(key) {
    console.log("get storeage".concat(userId).concat(key));
